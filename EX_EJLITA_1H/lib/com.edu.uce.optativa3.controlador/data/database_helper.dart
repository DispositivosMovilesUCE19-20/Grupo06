...
class DBHelper {
  ...
  void saveUser(String name, String lastname, String email, String celular,
    ...
    print(
        '[DBHelper] saveUser: Success | $name, $lastname, $email, $celular, $user, $password');

    User userJson =
        new User("j1", name, lastname, email, celular, user, password);
...
updateUser(String id,String name, String lastname, String email, String celular,
    ...
    var dbClient = await db;
    await dbClient.transaction((trans) async{
      return await trans.rawUpdate('UPDATE User SET name=\'$name\', lastname=\'$lastname\', email=\'$email\', celular=\'$celular\', user=\'$user\', password=\'$password\' WHERE id =\'$id\'');
    });
    print(
        '[DBHelper] updateUser: Success | $name, $lastname, $email, $celular, $user, $password');
